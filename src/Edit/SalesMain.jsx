...
const SalesMain = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`http://localhost:2233/solsalesforcemain/${id}`, {
            method: 'PATCH',
            headers: {
